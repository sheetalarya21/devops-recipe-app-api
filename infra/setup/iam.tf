...
data "aws_iam_policy_document" "tf_backend" {
  statement {
    ...
    resources = ["arn:aws:s3:::${var.tfs_state_bucket}"]
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:s3:::${var.tfs_state_bucket}/tf-state-deploy/*",
      "arn:aws:s3:::${var.tfs_state_bucket}/tf-state-deploy-env/*"
    ]
  }
  ...
  statement {
    ...
    resources = ["arn:aws:dynamodb:*:*:table/${var.tfs_state_lock_table}"]
  }
}
